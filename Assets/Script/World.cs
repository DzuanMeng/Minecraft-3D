...
public class World : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (modifications.Count > 0 && !applyModifications)
        {
    ...
    void RestartWordl()
    {
        ...
        spawnPosition = new Vector3((VoxelData.WorldSizeInChunks * VoxelData.ChunkWidth) / 2f, VoxelData.ChunkHeight - 50f, (VoxelData.WorldSizeInChunks * VoxelData.ChunkWidth) / 2f); playerLastChunkCoord = GetChunkCoordFromVector3(player.position);
        ...
        for (int x = 0; x < VoxelData.WorldSizeInChunks; x++)
        {
            for (int z = 0; z < VoxelData.WorldSizeInChunks; z++)
            {
                if (chunks[x, z] != null)
                {
                    GameObject.Destroy(chunks[x, z].chunkObject);
                    chunks[x, z] = null;
                }
            }
        }
